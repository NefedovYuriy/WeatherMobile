    ...
    return (
        <div className="flex weather__search-wrapper">
            <div className="weather__search">
                ...
                <input ref={inputRef} type="text" className="weather__search-input" placeholder="Enter city" />
            </div>
            <button onClick={handleClick} className="weather__search-button">
                <i style={{fontSize: 15, opacity: 0.5}} className="fa fa-plus" aria-hidden="true"></i>
            </button>
        </div>
    )
}
